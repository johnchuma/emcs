...
import { getUser, registerUser } from "../controllers/authController";
    ...
    <div className=" bg-dark h-screen py-16 font-aeonik text-textColor ">
      ...
      <div className="grid grid-cols-12 w-7/12 mx-auto bg-white rounded-lg shadow-2xl">
        ...
        <form
          ...
          className=" col-span-7  py-16 justify-center flex flex-col w-8/12 mx-auto items-start  text-start "
        >
        
          <div className="w-full text-textColor text-sm">
            <h1 className="font-bold text-2xl text-start">Create an account</h1>
          ...
          <div className="mt-2 text-start">
            ...
            navigate('/login')
          }} className="text-sm font-bold cursor-pointer">Login</span>
          </div>
