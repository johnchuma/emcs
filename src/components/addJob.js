            ...
            >
              ...
              <div className=" flex space-x-3 items-center">
                ...
                <h1 className="text-red-500 font-bold">
                  ...
                  TopTarget Limited. Be prepared to sign a commercial contract
                  and pay for the obvious costs when looking for the best
              ...
              <button
                type="submit"
                className="py-3 px-7 mt-5 font-bold bg-primary text-white flex justify-center w-40 "
              >
                {loading ? (
                  <div className="h-4 checked:text-green w-4 border-4 border-white border-t-transparent  animate-spin" />
                ) : (
                  "Publish Job"
                )}
              </button>
