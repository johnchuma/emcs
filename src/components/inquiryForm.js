      ...
      >
        <div className="mt-3">
          ...
          <input
            ...
            className="w-full rounded border-slate-100"
          />
        </div>
        ...
        <button className="py-3 w-full flex justify-center font-bold hover:bg-slate-900 transition-all bg-primary mt-8 text-white">
